  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-semibold text-slate-900">Sign in to Doctor Vai</h1>
      ...
      <div className="rounded-2xl border border-teal-100 bg-teal-50 p-4 text-xs text-teal-800">
        ...
        <p className="mt-1">Sign in with worker@health.gov / password123 to simulate a clinician.</p>
      </div>
